object frmSel_Ensaio: TfrmSel_Ensaio
  Left = 217
  Top = 61
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frmSel_Ensaio'
  ClientHeight = 575
  ClientWidth = 1015
  Color = clBtnFace
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMSel_Setor_Proc.dsmAuxiliar
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 498
      Height = 18
      Caption = 'Duplo Clique para Marcar ou Desmarcar o Teste / Ensaio'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clMaroon
      Font.Height = -16
      Font.Name = 'Verdana'
