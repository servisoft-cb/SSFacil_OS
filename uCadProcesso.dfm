object frmCadProcesso: TfrmCadProcesso
  Left = 183
  Top = 91
  Width = 787
  Height = 542
  BorderIcons = [biSystemMenu, biMaximize]
  Caption = 'frmCadProcesso'
  Color = clBtnFace
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object DBCheckBox1: TDBCheckBox
          ...
          Width = 225
          Height = 17
          Caption = 'Calcula a '#193'rea pra obter o valor do servi'#231'o'
          DataField = 'CALCULA_AREA'
          DataSource = DmCadSetor.dsProcesso
          TabOrder = 2
          ValueChecked = 'S'
          ValueUnchecked = 'N'
