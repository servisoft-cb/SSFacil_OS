...
type
  TDMProcesso_ES = class(TDataModule)
    ...
    qVerQTD: TFloatField;
    qVerQTD_CONCLUIDO: TFloatField;
    qVerQTD_EM_ABERTO: TFloatField;
    qVerQTD_ANT: TFloatField;
    qVerQTD_CONCLUIDA_ANT2: TFloatField;
    qVerQTD_JA_CONCLUIDA: TFloatField;
    qVerQTD_RESTANTE: TFloatField;
    qVerQTD_CONCLUIDA_ANT: TFloatField;
    mBaixaAuxQtd: TFloatField;
    qVerifica_ProcQTD: TFloatField;
    qOS_ProcQTD: TFloatField;
    qOS_ProcQTD_RESTANTE: TFloatField;
    qOS_ProcQTD_CONCLUIDO: TFloatField;
    qOS_ProcQTD_CONCLUIDO_ANT: TFloatField;
    cdsOS_ProcQTD: TFloatField;
    cdsOS_ProcQTD_RESTANTE: TFloatField;
    cdsOS_ProcQTD_CONCLUIDO: TFloatField;
    ...
    sdsBaixa_OSQTD: TFloatField;
    cdsBaixa_OSQTD: TFloatField;
    qOS_ProcQTD_ITEM: TFloatField;
