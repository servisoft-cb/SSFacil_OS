...
type
  TfrmCadOrdemServico2 = class(TForm)
...
var
  frmCadOrdemServico2: TfrmCadOrdemServico2;
...
uses DmdDatabase, rsDBUtils, uUtilPadrao, USel_Pessoa, USel_Produto, UDMImpOrdemServico, UCadProduto, UAjustar_OS, USel_Orc,
  ...
  UConsOrdemServico, UCancela_OS, USel_CentroCusto;

{$R *.dfm}

procedure TfrmCadOrdemServico2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfrmCadOrdemServico2.btnExcluirClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnInserirClick(Sender: TObject);
begin
  prc_Inserir_Registro;
end;

procedure TfrmCadOrdemServico2.prc_Excluir_Registro;
begin
  fDMCadOrdemServico.prc_Excluir;
end;

procedure TfrmCadOrdemServico2.prc_Gravar_Registro;
var
  vIDAux: Integer;
  ID: TTransactionDesc;
  vVlrTotal: Real;
...
procedure TfrmCadOrdemServico2.prc_Inserir_Registro;
begin
...
procedure TfrmCadOrdemServico2.FormShow(Sender: TObject);
var
  i: Integer;
  vData: TDateTime;
begin
...
procedure TfrmCadOrdemServico2.prc_Consultar(ID: Integer);
begin
...
procedure TfrmCadOrdemServico2.btnConsultarClick(Sender: TObject);
begin
  prc_Consultar(0);
end;

procedure TfrmCadOrdemServico2.btnCancelarClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnAlterarClick(Sender: TObject);
var
  vCodAux: String;
begin
...
procedure TfrmCadOrdemServico2.btnConfirmarClick(Sender: TObject);
begin
  prc_Gravar_Registro;
end;

procedure TfrmCadOrdemServico2.FormDestroy(Sender: TObject);
begin
  FreeAndNil(fDMCadOrdemServico);
end;

procedure TfrmCadOrdemServico2.prc_Posiciona_OS;
begin
...
function TfrmCadOrdemServico2.fnc_Verifica_Registro: Boolean;
begin
  Result := False;
...
procedure TfrmCadOrdemServico2.RzPageControl1Change(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.pnlClienteExit(Sender: TObject);
begin
  prc_Posicionar_Cliente;
end;

procedure TfrmCadOrdemServico2.prc_Posicionar_Cliente;
begin
...
procedure TfrmCadOrdemServico2.prc_Habilitar_Campos;
begin
...
function TfrmCadOrdemServico2.fnc_Cancelar: Boolean;
begin
  Result := True;
...
procedure TfrmCadOrdemServico2.SpeedButton1Click(Sender: TObject);
begin
  fDMCadOrdemServico.cdsCliente.Close;
  fDMCadOrdemServico.cdsCliente.Open;
end;

procedure TfrmCadOrdemServico2.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  CanClose := fnc_Encerrar_Tela(fDMCadOrdemServico.cdsOrdemServico);
end;

procedure TfrmCadOrdemServico2.edtSerieKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmCadOrdemServico2.CurrencyEdit1KeyDown(Sender: TObject;
...
procedure TfrmCadOrdemServico2.Edit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = Vk_Return then
    btnConsultarClick(Sender);
...
procedure TfrmCadOrdemServico2.RxDBLookupCombo3KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (Key = Vk_F2) then
  begin
...
procedure TfrmCadOrdemServico2.SMDBGrid1TitleClick(Column: TColumn);
var
  i: Integer;
...
procedure TfrmCadOrdemServico2.Panel4Enter(Sender: TObject);
begin
  vID_Cliente_Ant := fDMCadOrdemServico.cdsOrdemServicoID_CLIENTE.AsInteger;
end;

procedure TfrmCadOrdemServico2.SMDBGrid1GetCellParams(Sender: TObject;
...
procedure TfrmCadOrdemServico2.SMDBGrid1DblClick(Sender: TObject);
begin
  RzPageControl1.ActivePage := TS_Cadastro;
end;

procedure TfrmCadOrdemServico2.btnPesquisarClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.prc_Limpar_Edit_Consulta;
begin
  CurrencyEdit1.Clear;
  Edit2.Clear;
end;

function TfrmCadOrdemServico2.fnc_Existe_Fat(Item: Integer): Boolean;
var
  sds: TSQLDataSet;
begin
  Result := False;
...
procedure TfrmCadOrdemServico2.SMDBGrid4GetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmCadOrdemServico2.RxDBLookupCombo3Change(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.RxDBLookupCombo4Enter(Sender: TObject);
begin
  fDMCadOrdemServico.cdsVendedor.IndexFieldNames := 'NOME';
end;

procedure TfrmCadOrdemServico2.prc_Status;
begin
  Memo1.Lines.Clear;
...
procedure TfrmCadOrdemServico2.DBEdit6Exit(Sender: TObject);
begin
  prc_Calcular_DtEntrega;
end;

procedure TfrmCadOrdemServico2.prc_Calcular_DtEntrega;
begin
...
procedure TfrmCadOrdemServico2.DBDateEdit4Exit(Sender: TObject);
begin
  prc_Calcular_DtEntrega;
end;

procedure TfrmCadOrdemServico2.NxFlipProdEnter(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServico.State in [dsEdit,dsInsert] then
  begin
...
procedure TfrmCadOrdemServico2.btnInserir_ProcClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnAlterar_ProcClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnExcluir_ProcClick(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServico_ProcITEM_PROC.AsInteger <= 0 then
  begin
...
procedure TfrmCadOrdemServico2.DBEdit7KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmCadOrdemServico2.DBEdit7Exit(Sender: TObject);
begin
  if not(fDMCadOrdemServico.cdsOrdemServico.State in [dsEdit,dsInsert]) then
    exit;
  if not(fDMCadOrdemServico.cdsOrdemServico_Itens.State in [dsEdit,dsInsert]) then
...
procedure TfrmCadOrdemServico2.btnInserir_MatClick(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServicoID_CLIENTE.AsInteger <= 0 then
  begin
    MessageDlg('*** Cliente não foi informado!', mtInformation, [mbOk], 0);
...
procedure TfrmCadOrdemServico2.btnAlterar_MatClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnExcluir_MatClick(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServico_MatITEM_MAT.AsInteger <= 0 then
  begin
    MessageDlg('*** Não existe registro para excluir!', mtInformation, [mbOk], 0);
...
procedure TfrmCadOrdemServico2.RxDBLookupCombo5Enter(Sender: TObject);
begin
  RxDBLookupCombo5.ReadOnly := (fDMCadOrdemServico.cdsOrdemServico_Proc.RecordCount > 0);
end;

procedure TfrmCadOrdemServico2.btnInserir_TercClick(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServicoID_CLIENTE.AsInteger <= 0 then
  begin
    MessageDlg('*** Cliente não foi informado!', mtInformation, [mbOk], 0);
...
procedure TfrmCadOrdemServico2.btnAlterar_TercClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnExcluir_TercClick(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServico_TercITEM_TERC.AsInteger <= 0 then
  begin
    MessageDlg('*** Não existe registro para excluir!', mtInformation, [mbOk], 0);
...
procedure TfrmCadOrdemServico2.btnImprimirClick(Sender: TObject);
var
  vArq: String;
...
procedure TfrmCadOrdemServico2.SMDBGrid2GetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmCadOrdemServico2.N1Click(Sender: TObject);
var
 Reg: TBookMark;
 vAux: Integer;
begin
...
procedure TfrmCadOrdemServico2.N2Click(Sender: TObject);
var
 Reg: TBookMark;
begin
  if not(fDMCadOrdemServico.cdsOrdemServico.State in [dsEdit,dsInsert]) then
...
function TfrmCadOrdemServico2.fnc_Existe_Baixa(Ordem: Integer): Boolean;
begin
  Result := False;
  fDMCadOrdemServico.qVerifica_Baixa.Close;
...
procedure TfrmCadOrdemServico2.RzPageControl2Change(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnConsultar_RealizadoClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.btnConsultar_PausaClick(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.SMDBGrid5GetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmCadOrdemServico2.prc_VerBaixas;
begin
  if (fDMCadOrdemServico.qVerBaixaOSCONT_BAIXAS.AsInteger > 0) or (fDMCadOrdemServico.qVerBaixaOSCONT_MAT.AsInteger > 0) then
...
function TfrmCadOrdemServico2.fnc_Verifica_Baixa_Proc(Num_OS,
...
procedure TfrmCadOrdemServico2.SpeedButton2Click(Sender: TObject);
var
...
procedure TfrmCadOrdemServico2.btnCalcular_CustoClick(Sender: TObject);
var
  vVlrProcesso: Real;
...
procedure TfrmCadOrdemServico2.SMDBGrid7GetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmCadOrdemServico2.btnAlterar_RealizadoClick(Sender: TObject);
var
...
procedure TfrmCadOrdemServico2.prc_Montar_Ordem;
var
  vItemAux: Integer;
  vOrdem: Integer;
begin
...
procedure TfrmCadOrdemServico2.btnEncerrar_OSClick(Sender: TObject);
var
...
procedure TfrmCadOrdemServico2.prc_Abrir_cdsOrdemServico_Enc;
begin
...
procedure TfrmCadOrdemServico2.btnRetrabalhoClick(Sender: TObject);
var
...
procedure TfrmCadOrdemServico2.DBEdit11KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (Key = Vk_F2) then
  begin
...
procedure TfrmCadOrdemServico2.btnCopiarOrcamentoClick(Sender: TObject);
var
...
procedure TfrmCadOrdemServico2.RzGroupBox2Enter(Sender: TObject);
begin
...
function TfrmCadOrdemServico2.fnc_Encerrar(ID: Integer): Boolean;
var
  sds: TSQLDataSet;
begin
  Result := False;
...
procedure TfrmCadOrdemServico2.btnLiberarClick(Sender: TObject);
var
...
procedure TfrmCadOrdemServico2.DBEdit21KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (Key = Vk_F2) then
...
procedure TfrmCadOrdemServico2.DBEdit17KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (Key = Vk_F2) then
    btBuscaProduto.Click;
...
procedure TfrmCadOrdemServico2.DBEdit21Exit(Sender: TObject);
begin
...
procedure TfrmCadOrdemServico2.prc_Monta_Grid2;
var
  i : Integer;
begin
...
procedure TfrmCadOrdemServico2.SMDBGrid1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
var
...
procedure TfrmCadOrdemServico2.btnExcluir_RealizadoClick(Sender: TObject);
var
  ID: TTransactionDesc;
begin
  if fDMCadOrdemServico.cdsOrdemServico.State in [dsEdit,dsInsert] then
...
procedure TfrmCadOrdemServico2.btnCancelar_OSClick(Sender: TObject);
begin
  if not(fDMCadOrdemServico.cdsOrdemServico_Consulta.Active) or (fDMCadOrdemServico.cdsOrdemServico_Consulta.IsEmpty) then
    exit;
...
procedure TfrmCadOrdemServico2.DBEdit14Exit(Sender: TObject);
begin
  if (StrToFloat(FormatFloat('0.0000',vQtdNota_Ant)) <> StrToFloat(FormatFloat('0.0000',fDMCadOrdemServico.cdsOrdemServico_ItensQTD_NOTA.AsFloat)))
...
procedure TfrmCadOrdemServico2.DBEdit2KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if (Key = vkF12) then
  begin
    vID_Centro_Custo := fDMCadOrdemServico.cdsOrdemServicoID_CENTROCUSTO.AsInteger;
    frmSel_CentroCusto := TfrmSel_CentroCusto.Create(self);
    frmSel_CentroCusto.ShowModal;
    FreeAndNil(frmSel_CentroCusto);
    fDMCadOrdemServico.cdsOrdemServicoID_CENTROCUSTO.AsInteger := vID_Centro_Custo;
    edtNomeCentroCusto.Text := SQLLocate('CENTROCUSTO','ID','DESCRICAO',fDMCadOrdemServico.cdsOrdemServicoID_CENTROCUSTO.AsString);
  end;
end;

procedure TfrmCadOrdemServico2.DBEdit2Exit(Sender: TObject);
begin
  if fDMCadOrdemServico.cdsOrdemServicoID_CENTROCUSTO.AsInteger > 0 then
    edtNomeCentroCusto.Text := SQLLocate('CENTROCUSTO','ID','DESCRICAO',fDMCadOrdemServico.cdsOrdemServicoID_CENTROCUSTO.AsString)
  else
